...
const categories = ["Kuliner", "Kerajinan", "Fashion", "Kopi", "Pertanian"] as const
    ...
    setItems((prev) => [
      {
        ...
        photoUrl: values.photoUrl && values.photoUrl.length > 0 ? values.photoUrl : "/umkm-photo.jpg",
        createdAt: new Date().toISOString(),
      },
      ...prev,
    ])
    ...
    <div className="flex flex-col gap-6">
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage SME entries</p>
        </div>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Fill out the form to add a new SME entry.</DialogDescription>
        </DialogHeader>
        <form className="grid gap-4" onSubmit={handleSubmit(submit)}>
          <div className="grid gap-2">
            <Label htmlFor="name">Name</Label>
            <Input id="name" {...register("name")} placeholder="e.g., Kopi Nusantara" />
          ...
          <div className="grid gap-2">
            ...
            <Input id="location" {...register("location")} placeholder="e.g., Pusat Kota" />
